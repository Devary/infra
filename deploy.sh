...
if [[ -n "${RD_OPTION_IMAGE:-}" ]]; then
  ...
  VAULT_KV_MOUNT="${RD_OPTION_VAULTKVMOUNT:-${VAULT_KV_MOUNT:-kv}}"
  ...
  JWT_ISSUER="${RD_OPTION_JWTISSUER:-${JWT_ISSUER:-}}"
  KEYCLOAK_TOKEN_URL="${RD_OPTION_KEYCLOAKTOKENURL:-${KEYCLOAK_TOKEN_URL:-}}"
  KEYCLOAK_CLIENT_ID="${RD_OPTION_KEYCLOAKCLIENTID:-${KEYCLOAK_CLIENT_ID:-}}"
  GATEWAY_AUTH_ENABLED="${RD_OPTION_GATEWAYAUTHENABLED:-${GATEWAY_AUTH_ENABLED:-}}"
else
  ...
  GATEWAY_AUTH_ENABLED="${GATEWAY_AUTH_ENABLED:-}"
fi
